  ...
  return (
    <Router>
      ...
      <Routes>
          ...
          {user && <Route path="/" element={<Header />} />}
          <Route path="/profile" element={<StudentView />} />
          <Route path="/wishlist" element={<Wishlist wishlist={wishlist} onWishlistUpdate={handleWishlistUpdate} />} />
          <Route
            path="/faculty"
            element={<MultiFilters onWishlistUpdate={handleWishlistUpdate} wishlist={wishlist} />}
          />
          {!user && <Route path="/" element={<Navigate replace to="/login" />} />} */}
        </Routes>
      </div>
